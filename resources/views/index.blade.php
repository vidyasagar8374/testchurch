...
@extends('base') @section('title', 'infant Jesus Shrine') @section('content')
  ...
  <div class="container my-5">
      <div class="row align-items-center">
          ...
          <div class="col-md-6 order-md-1 order-1 text-center text-md-start" data-aos="fade-up">
              ...
              <a href=""  target="_blank"><button type="button" class="btn btn-link mt-1 mb-1">Read more..</button></a>
          </div>
    ...
    <div class="container my-5">
      <div class="row align-items-center">
          ...
          <div class="col-md-6 order-md-2 order-1 text-center text-md-start" data-aos="fade-up">
              <h2>Now live</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
              <a href="" target="_blank"><button type="button" class="btn btn-link mt-1 mb-1">click here more</button></a>
          </div>
